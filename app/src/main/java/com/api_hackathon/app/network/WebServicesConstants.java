package com.api_hackathon.app.network;
...
public class WebServicesConstants {
    ...
    public static String ivrURL="http://dev.knowlarity.com/api/voice/";
    public static String serverURL="http://whispering-reaches-1551.herokuapp.com/";
    ...
    public static String serverRequest = "quickCall";
